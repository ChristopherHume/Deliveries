...
namespace Deliveries.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ItemId,CustomerId,DeliveryTime")] Delivery delivery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ItemId,CustomerId,DeliveryTime")] Delivery delivery)
        {
            if (id != delivery.Id)
            {
                return NotFound();
